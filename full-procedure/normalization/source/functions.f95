...
subroutine export
    open(export_file, file='./results/normalized-f.txt', status='unknown', action='write')
    write(export_file,*) f
    close(export_file)
...
subroutine init
        ...
        open(input_file, file='../parameters/normalization-parameters.txt', status='old', action='read')
